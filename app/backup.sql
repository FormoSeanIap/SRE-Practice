...
CREATE TABLE `columns_priv` (
  ...
  `Db` char(64) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
  `User` char(32) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
  `Table_name` char(64) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
  `Column_name` char(64) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `default_roles` (
  ...
  `DEFAULT_ROLE_USER` char(32) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `func` (
  `name` char(64) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
  `ret` tinyint NOT NULL DEFAULT '0',
  `dl` char(128) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `password_history` (
  ...
  `Password` text CHARACTER SET utf8mb3 COLLATE utf8_bin,
...
CREATE TABLE `procs_priv` (
  ...
  `Routine_type` enum('FUNCTION','PROCEDURE') CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `Grantor` varchar(288) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `proxies_priv` (
  ...
  `Proxied_user` char(32) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `role_edges` (
  ...
  `FROM_USER` char(32) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
  `TO_HOST` char(255) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL DEFAULT '',
  `TO_USER` char(32) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `user` (
  ...
  `plugin` char(64) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL DEFAULT 'caching_sha2_password',
  `authentication_string` text CHARACTER SET utf8mb3 COLLATE utf8_bin,
...
--
-- Current Database: `ser_practice_test`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ser_practice_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `ser_practice_test`;
...
--
-- Current Database: `sre_practice`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sre_practice` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Current Database: `sre_practice_test`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sre_practice_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Dump completed on 2022-07-20 12:57:40
